...
DEFAULT_FROM_EMAIL = "ShareIt App <thrivesync1@gmail.com>"
...
ALLOWED_HOSTS = ["shareit-d5pq.onrender.com", "localhost", "127.0.0.1"]
...
STATIC_URL = '/static/'
# If you keep a "static" folder inside apps or project
